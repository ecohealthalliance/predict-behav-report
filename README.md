...
*Note 1: variables in the Numeric Tables and Median Plots remain the same, regardless of the outcome variable. However, depending on the type of outcome variable (whether illness or taxa contact), the variables in the 
Categorical Tables and Confidence Interval Plots do change slightly.
