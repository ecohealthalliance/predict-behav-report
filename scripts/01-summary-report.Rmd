...
fdat <- read_csv(h(paste0("data/formatted-behav-", country, ".csv")))
...
# ggsave(plot = hm, file = h("outputs/heat maps", paste0(country, "-heat-map.png")), width = 15, height = 7.5, units = "in")
...
gender_dat <- bind_cols(dat %>% select(gender), fdat) %>%
...
# ggsave(plot = hm, file = h("outputs/heat maps", paste0(country, "-gender-heat-map.png")), width = 15, height = 7.5, units = "in")
...
edu_dat <- bind_cols(dat %>% select(highest_education), fdat) %>%
...
# ggsave(plot = hm, file = h("outputs/heat maps", paste0(country, "-educ-heat-map.png")), width = 15, height = 15, units = "in")
