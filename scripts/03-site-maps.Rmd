...
# Set color palette 
bins <- seq(min(quest$n), max(quest$n), length.out = 7) %>% round()
...
leaflet(age_map) %>%
  ...
  addCircleMarkers( 
    ...
    popup = c(popup_image_mod(age_map$age_pngpath[1]),
              popup_image_mod(age_map$age_pngpath[2]),
              popup_image_mod(age_map$age_pngpath[3]),
              popup_image_mod(age_map$age_pngpath[4]),
              popup_image_mod(age_map$age_pngpath[5]) )) %>%
  addPolygons(
    data = admin, opacity = 100,
    color = "#000000",
    weight = 1, popup = NULL,
...
leaflet(contact_map) %>%
  ...
  addCircleMarkers(
    ...
    popup = c(
      popup_image_mod(contact_map$contact_pngpath[1], width = 300, height = 115),
      popup_image_mod(contact_map$contact_pngpath[2], width = 300, height = 115),
      popup_image_mod(contact_map$contact_pngpath[3], width = 300, height = 115),
      popup_image_mod(contact_map$contact_pngpath[4], width = 300, height = 115),
      popup_image_mod(contact_map$contact_pngpath[5], width = 300, height = 115) )) %>%
  addPolygons(
    data = admin, opacity = 100,
    color = "#000000",
    weight = 1, popup = NULL,
